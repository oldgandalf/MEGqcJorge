...
def make_std_peak_report(sid: str, what_data: str, list_of_figure_paths: list, config):
    ...
    # single_html_string = make_html_section(figure_report=figures_report['f0'])
    # extra_html_string = ''
    ...
    # elif default_section['do_for'] == 'both' and not default_section['stim_channel']:
    #     extra_html_string = make_html_section(figure_report=figures_report['f1'])
    #     print('CASE3')

    # #case4: 4 plots: mag AND grad, with epoching
    # elif default_section['do_for'] == 'both' and default_section['stim_channel']:
    #     extra_html_string1 = make_html_section(figure_report=figures_report['f1'])
