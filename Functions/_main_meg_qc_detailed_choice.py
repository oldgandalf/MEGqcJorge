# This version of main allows to do EVERY SEPARATE QC step for mags or grads.
# We decided it s not nessesary, os it is just left for the possible future use.
