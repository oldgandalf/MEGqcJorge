        ...
        for sid in list_of_subs[4:5]: 
            ...
            for fif_ind, data_file in enumerate(list_of_fifs[0:1]): 
                ...
                if all_qc_params['default']['run_PSD'] is True:
                    ...
                    start_time = time.time()
                    psd_derivs, simple_metrics_psd, psd_str, noisy_freqs_global = PSD_meg_qc(all_qc_params['PSD'], channels, chs_by_lobe , raw_cropped_filtered, m_or_g_chosen, helperplots=False)
                ...
                if all_qc_params['default']['run_ECG'] is True:
                    ...
                    start_time = time.time()
                    ecg_derivs, simple_metrics_ecg, ecg_str, avg_objects_ecg = ECG_meg_qc(all_qc_params['ECG'], raw_cropped, channels, chs_by_lobe, m_or_g_chosen)
                ...
                if all_qc_params['default']['run_EOG'] is True:
                    ...
                    start_time = time.time()
                    eog_derivs, simple_metrics_eog, eog_str, avg_objects_eog = EOG_meg_qc(all_qc_params['EOG'], raw_cropped, channels, chs_by_lobe, m_or_g_chosen)
                ...
                if all_qc_params['default']['run_Muscle'] is True:
                    ...
                    muscle_derivs, simple_metrics_muscle, muscle_str, scores_muscle_all3, raw3 = MUSCLE_meg_qc(all_qc_params['Muscle'], all_qc_params['PSD'], raw_cropped_filtered, noisy_freqs_global, m_or_g_chosen, interactive_matplot=False, attach_dummy = True, cut_dummy = True)
